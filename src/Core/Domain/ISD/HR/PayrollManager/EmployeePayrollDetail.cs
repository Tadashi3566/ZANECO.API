...
public class EmployeePayrollDetail : AuditableEntity, IAggregateRoot
{
    ...
    public EmployeePayrollDetail(DefaultIdType employeeId, string employeeName, DefaultIdType payrollId, string payrollName, DefaultIdType adjustmentId, string adjustmentType, string adjustmentName, decimal amount, DateTime startDate, DateTime endDate, DateTime payrollDate, string contributor, string? description = null, string? notes = null)
    {
    ...
    public EmployeePayrollDetail Update(string employeeName, string payrollName, string adjustmentName, decimal amount, DateTime startDate, DateTime endDate, DateTime payrollDate, string contributor, string? description = null, string? notes = null)
    {
