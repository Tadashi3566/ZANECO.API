...
public class Rate : AuditableEntity, IAggregateRoot
{
    ...
    public Rate(int number, string name, string? description = null, string? notes = null)
    {
        Number = number;
    ...
    public Rate Update(int number, string name, string? description = null, string? notes = null)
    {
